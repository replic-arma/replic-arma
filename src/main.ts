...
import { Collection, GameServer, JSONMap, Modset } from './models/Repository';
...
//         modsets: new JSONMap<string, Modset>()
...
//                 mods: [{ name: 'RHS', mod_type: uuidv4() }]
//             }),
//         collections: new JSONMap<string, Collection>().set('8578d596-a17e-4f74-95f3-a48e41240f24', { id: '8578d596-a17e-4f74-95f3-a48e41240f24', name: 'Dev' })
//     }
// );
// repoStore.addRepo(
//     {
...
//                 mods: [{ name: 'RHS', mod_type: uuidv4() }]
//             }),
//         collections: new JSONMap<string, Collection>()
//     }
// );
// repoStore.addRepo(
//     {
...
//         type: 'a3s',
//         game_servers: new JSONMap<string, GameServer>()
//             .set('9c0d278a-692c-4cf7-ad5c-4658995bb872', { id: '9c0d278a-692c-4cf7-ad5c-4658995bb872', name: 'Gruppe Adler Main', port: '2302', host: 'arma.gruppe-adler.de', password: 'helium', modset: 'Gruppe Adler Main' })
//             .set('a9a8f5c7-2cce-4eae-b58a-09b135f98d96', { id: 'a9a8f5c7-2cce-4eae-b58a-09b135f98d96', name: 'Gruppe Adler Test', port: '2402', host: 'arma.gruppe-adler.de', password: 'methan' })
//             .set('b06bc7e1-059b-4cf9-834b-0cedda445981', { id: 'b06bc7e1-059b-4cf9-834b-0cedda445981', name: 'Gruppe Adler Test', port: '2402', host: 'arma.gruppe-adler.de' }),
//         modsets: new JSONMap<string, Modset>()
