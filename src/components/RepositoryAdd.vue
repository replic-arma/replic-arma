<template>
    <replic-dialog :dialogName="'repoName'">
        <template v-slot:header>
            <span>Add Repo</span>
            <mdicon role="button" @click="dialogStore.toggleDialog('repoName')" name="close" size="35" />
        </template>
...
export default class RepositoryAddVue extends Vue {
    ...
    private toggleDialog = () => { this.dialogStore.toggleDialog('repoName'); };
}
</script>
