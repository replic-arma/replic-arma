<template>
    <div class="general-settings">
        <replic-path-selector :pathSelector="{label: $t('a3exe'), name:'a3exe' }" v-model="settingsCopy.gamePath"></replic-path-selector>
        <replic-path-selector :pathSelector="{label: $t('mod_directory'), name:'modDirectory' }" :pathSelectorOptions="{directory: true}" v-model="settingsCopy.downloadDirectoryPath"></replic-path-selector>
    ...
    <div class="general-settings__theme">
        ...
        <div class="general-settings__buttons">
            ...
            <button class="button button--danger" type="button" @click="settingsStore.resetSettings()">{{$t('settings.reset')}}</button>
